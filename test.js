...
const employees = [
  {
    email: "albus@blue.bank",
    first_name: "Albus",
    last_name: "Dumbledore",
  },
  {
    email: "sirius@blue.bank",
    first_name: "Sirius",
    last_name: "Black",
  },
  {
    email: "luna@blue.bank",
    first_name: "Luna",
    last_name: "Lovegood",
  },
];
...
const users = async () => {
  ...
  await permit.api.roleAssignments.bulkAssign(
    ["sirius@blue.bank", "luna@blue.bank"].map((email) => ({
      role: "representative",
      user: email,
      tenant: "default",
    }))
  ...
  await permit.api.roleAssignments.assign({
    role: "manager",
    user: "albus@blue.bank",
    tenant: "default",
  });
  await permit.api.roleAssignments.assign({
    role: "editor",
    resource_instance: "account:harry",
    user: "sirius@blue.bank",
  });
  await permit.api.roleAssignments.assign({
    role: "editor",
...
(async () => {
  ...
  assert(allowed, "Albus should be able to list representatives");
})();
